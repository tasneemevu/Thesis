...
from . import views
from .views import  AnnotationListCreateView, SubmitAnnotationView, SaveAnnotatedImageView, SavePaymentCodeView
...
urlpatterns = [
    ...
    path('api/save-payment-code/', SavePaymentCodeView.as_view(), name='save-payment-code'),
